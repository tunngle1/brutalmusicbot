...
const AppContent: React.FC = () => {
  ...
  return (
    <div className="relative min-h-tg-screen bg-lebedev-black text-lebedev-white pb-24 overflow-x-hidden">
      {/* Main Content Area */}
      ...
      {user?.is_admin && currentView !== ViewState.ADMIN && (
        <button
          ...
          className="fixed top-4 right-4 z-40 p-3 bg-lebedev-white text-lebedev-black border-2 border-lebedev-white hover:bg-lebedev-red hover:text-lebedev-white hover:border-lebedev-red transition-colors font-bold uppercase"
        >
